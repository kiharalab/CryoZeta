...
# atom37 vdw table. Orders match atom37 indices.
# Note: the vdw's for N and O are different from rdkit_van_der_waals in this file.
# We used the rdkit values for consistency.
# Ref: https://github.com/aqlaboratory/openfold/blob/80c85b54e1a81d9a66df3f1b6c257ff97f10acd3/openfold/utils/loss.py#L1208C5-L1211C6
# rdkit_van_der_waals_radius = {"C": 1.7, "N": 1.6, "O": 1.55, "S": 1.8}
# atom37_vdw = [rdkit_van_der_waals_radius[name[0]] for name in residue_constants.atom_types]
atom37_vdw = [
    1.55,
    1.7,
    1.7,
