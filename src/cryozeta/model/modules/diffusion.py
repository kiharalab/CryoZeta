...
from cryozeta.model.modules.embedders import FourierEmbedding, RelativePositionEncoding
from cryozeta.model.modules.primitives import LinearNoBias, Transition
from cryozeta.model.modules.transformer import (
    AtomAttentionDecoder,
    AtomAttentionEncoder,
    DiffusionTransformer,
)
from cryozeta.model.utils import expand_at_dim
from cryozeta.openfold_local.model.primitives import LayerNorm
from cryozeta.openfold_local.utils.checkpointing import get_checkpoint_fn
...
class DiffusionModule(nn.Module):
    ...
    def __init__(
        ...
        c_z: int = 128,
        c_s_inputs: int = 449,
        atom_encoder: dict[str, int] | None = None,
        transformer: dict[str, int] | None = None,
        atom_decoder: dict[str, int] | None = None,
