...
from cryozeta.model.modules.transformer import AtomAttentionEncoder
...
class InputFeatureEmbedder(nn.Module):
    ...
    def __init__(
        ...
        self.linear_pz = LinearNoBias(pz_dim, c_pz)
        self.linear_p = LinearNoBias(p_dim, c_p)
    ...
    def forward(
        ...
        pz_emd = self.linear_pz(input_feature_dict["pz"])
        p_emd = self.linear_p(input_feature_dict["p"])

        return s_inputs, pz_emd, p_emd
